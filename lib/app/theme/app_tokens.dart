...
/// The Guesgo design tokens, attached to `ThemeData.extensions`.
///
...
class AppTokens extends ThemeExtension<AppTokens> {
  ...
  /// Vertical scrim laid over hero photography (posters, backdrops) so
  /// white text stays legible whatever the image is.
