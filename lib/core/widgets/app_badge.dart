...
enum BadgeStyle {
  ...
  /// ("Nouveau", "En cours de téléchargement").
  solid,
...
/// A pulsing dot + label, for states that benefit from motion (download in
...
/// Numeric counter chip — unread notifications, "ma liste" count, filters
