...
/// [hint] carries the constraint before the user can get it wrong, so
/// validation errors become the exception.
...
/// Read-only row that opens a picker (date, sort, filter).
///
