...
extension ResultUnwrapX<T> on Result<T> {
  /// Unwraps to the value, or throws the [Failure] itself. Meant for
  /// Riverpod providers: `AsyncValue.error` then carries the [Failure]
  /// directly, which [AsyncValueWidget] special-cases to show its French
